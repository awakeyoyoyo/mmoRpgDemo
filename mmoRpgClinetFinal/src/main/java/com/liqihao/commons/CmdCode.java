...
public enum  CmdCode {
    ...
    FIND_ALL_ROLES_REQUEST_CMD(ConstantValue.SCENE_MODULE,ConstantValue.FIND_ALL_ROLES_REQUEST,ConstantValue.ASK_CAN_REQUEST_CMD),
    WENT_REQUEST_CMD(ConstantValue.SCENE_MODULE,ConstantValue.WENT_REQUEST,ConstantValue.WENT_REQUEST_CMD),
    WHERE_REQUEST_CMD(ConstantValue.SCENE_MODULE,ConstantValue.WHERE_REQUEST,ConstantValue.WHERE_REQUEST_CMD),
