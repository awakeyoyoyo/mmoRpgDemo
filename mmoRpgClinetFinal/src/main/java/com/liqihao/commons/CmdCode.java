...
public enum  CmdCode {
    ...
    ENTER_COPY_SCENE_REQUEST_CMD(ConstantValue.ENTER_COPY_SCENE_REQUEST,ConstantValue.ENTER_COPY_SCENE_REQUEST_CMD),
    EXIT_COPY_SCENE_REQUEST_CMD(ConstantValue.EXIT_COPY_SCENE_REQUEST,ConstantValue.EXIT_COPY_SCENE_REQUEST_CMD),
    ...
    GET_EMAIL_MONEY_REQUEST_CMD(ConstantValue.GET_EMAIL_MONEY_REQUEST,ConstantValue.GET_EMAIL_MONEY_REQUEST_CMD),
    ADD_SELL_ARTICLE_REQUEST_CMD(ConstantValue.ADD_SELL_ARTICLE_REQUEST,ConstantValue.ADD_SELL_ARTICLE_REQUEST_CMD),
    REDUCE_SELL_ARTICLE_REQUEST_CMD(ConstantValue.REDUCE_SELL_ARTICLE_REQUEST,ConstantValue.REDUCE_SELL_ARTICLE_REQUEST_CMD),
    REDUCE_AUCTION_ARTICLE_REQUEST_CMD(ConstantValue.REDUCE_AUCTION_ARTICLE_REQUEST,ConstantValue.REDUCE_AUCTION_ARTICLE_REQUEST_CMD),
    BUY_ARTICLE_REQUEST_CMD(ConstantValue.BUY_ARTICLE_REQUEST,ConstantValue.BUY_ARTICLE_REQUEST_CMD),
    AUCTION_ARTICLE_REQUEST_CMD(ConstantValue.AUCTION_ARTICLE_REQUEST,ConstantValue.AUCTION_ARTICLE_REQUEST_CMD),
    GET_ARTICLE_REQUEST_CMD(ConstantValue.GET_ARTICLE_REQUEST,ConstantValue.GET_ARTICLE_REQUEST_CMD),
    GET_PEOPLE_TASK_REQUEST_CMD(ConstantValue.GET_PEOPLE_TASK_REQUEST,ConstantValue.GET_PEOPLE_TASK_REQUEST_CMD),
    GET_CAN_ACCEPT_TASK_REQUEST_CMD(ConstantValue.GET_CAN_ACCEPT_TASK_REQUEST,ConstantValue.GET_CAN_ACCEPT_TASK_REQUEST_CMD),
    ACCEPT_TASK_REQUEST_CMD(ConstantValue.ACCEPT_TASK_REQUEST,ConstantValue.ACCEPT_TASK_REQUEST_CMD),
    ABANDON_TASK_REQUEST_CMD(ConstantValue.ABANDON_TASK_REQUEST,ConstantValue.ABANDON_TASK_REQUEST_CMD),
    APPLY_FRIEND_REQUEST_CMD(ConstantValue.APPLY_FRIEND_REQUEST,ConstantValue.APPLY_FRIEND_REQUEST_CMD),
    AGREE_FRIEND_REQUEST_CMD(ConstantValue.AGREE_FRIEND_REQUEST,ConstantValue.AGREE_FRIEND_REQUEST_CMD),
    REFUSE_FRIEND_REQUEST_CMD(ConstantValue.REFUSE_FRIEND_REQUEST,ConstantValue.REFUSE_FRIEND_REQUEST_CMD),
    GET_FRIENDS_REQUEST_CMD(ConstantValue.GET_FRIENDS_REQUEST,ConstantValue.GET_FRIENDS_REQUEST_CMD),
    FRIEND_APPLY_LIST_REQUEST_CMD(ConstantValue.FRIEND_APPLY_LIST_REQUEST,ConstantValue.FRIEND_APPLY_LIST_REQUEST_CMD),
    REDUCE_FRIEND_REQUEST_CMD(ConstantValue.REDUCE_FRIEND_REQUEST,ConstantValue.REDUCE_FRIEND_REQUEST_CMD),
    FINISH_TASK_REQUEST_CMD(ConstantValue.FINISH_TASK_REQUEST,ConstantValue.FINISH_TASK_REQUEST_CMD),
