...
public enum  CmdCode {
    ...
    ASK_CAN_COPYSCENE_REQUEST_CMD(ConstantValue.ASK_CAN_COPYSCENE_REQUEST,ConstantValue.ASK_CAN_COPYSCENE_REQUEST_CMD),

    COPYSCENE_MESSAGE_REQUEST_CMD(ConstantValue.COPYSCENE_MESSAGE_REQUEST,ConstantValue.COPYSCENE_MESSAGE_REQUEST_CMD),

    CREATE_COPYSCENE_REQUEST_CMD(ConstantValue.CREATE_COPYSCENE_REQUEST,ConstantValue.CREATE_COPYSCENE_REQUEST_CMD),

    ENTER_COPYSCENE_REQUEST_CMD(ConstantValue.ENTER_COPYSCENE_REQUEST,ConstantValue.ENTER_COPYSCENE_REQUEST_CMD),
    EXIT_COPYSCENE_REQUEST_CMD(ConstantValue.EXIT_COPYSCENE_REQUEST,ConstantValue.EXIT_COPYSCENE_REQUEST_CMD),
